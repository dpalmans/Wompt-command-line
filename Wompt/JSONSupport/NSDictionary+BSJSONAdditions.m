...
{
    return [self jsonStringValueWithIndentLevel:jsonDoNotIndent];
}
...
//	NSMutableString *jsonString = [[NSMutableString alloc] initWithString:jsonObjectStartString];
    NSMutableString *jsonString = [[NSMutableString alloc] initWithString:@"~j~{"]; //DJP: Added socket-io ~j~ format
